...
blank = pygame.image.load(application_path+"/Empty.png")
left = pygame.image.load(application_path+"/arrow2.png")
left = pygame.transform.scale(left, (80, 43))
right = pygame.image.load(application_path+"/arrow1.png")
